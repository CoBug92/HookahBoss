...
export const tagProfiles: Record<string, "berry" | "fruit" | "citrus" | "dessert" | "beverage" | "herbal" | "spicy" | "fresh"> = {
  alcohol:"beverage",waffle:"dessert",whiskey:"beverage",pear:"fruit",guava:"fruit",melon:"fruit",jasmine:"herbal",bubblegum:"dessert",tea:"beverage",cactus:"herbal",kiwi:"fruit",sour:"citrus",jam:"dessert",coffee:"beverage",redcurrant:"berry",gooseberry:"berry",lime:"citrus",liqueur:"beverage",mango:"fruit",cookie:"dessert",pomelo:"citrus",sage:"herbal",sweet:"dessert",smoothie:"beverage",fruit:"fruit","condensed-milk":"dessert","energy-drink":"beverage",lilac:"herbal",
  cooling:"fresh",
...
export const tagNames: Record<string, [string, string]> = {
  alcohol:["Алкоголь","Alcohol"],waffle:["Вафли","Waffle"],whiskey:["Виски","Whiskey"],pear:["Груша","Pear"],guava:["Гуава","Guava"],melon:["Дыня","Melon"],jasmine:["Жасмин","Jasmine"],bubblegum:["Жвачка","Bubblegum"],tea:["Чай","Tea"],cactus:["Кактус","Cactus"],kiwi:["Киви","Kiwi"],sour:["Кислый","Sour"],jam:["Джем","Jam"],coffee:["Кофе","Coffee"],redcurrant:["Красная смородина","Redcurrant"],gooseberry:["Крыжовник","Gooseberry"],lime:["Лайм","Lime"],liqueur:["Ликёр","Liqueur"],mango:["Манго","Mango"],cookie:["Печенье","Cookie"],pomelo:["Помело","Pomelo"],sage:["Шалфей","Sage"],sweet:["Сладкий","Sweet"],smoothie:["Смузи","Smoothie"],fruit:["Фрукты","Fruit"],"condensed-milk":["Сгущённое молоко","Condensed milk"],"energy-drink":["Энергетик","Energy drink"],lilac:["Сирень","Lilac"],
