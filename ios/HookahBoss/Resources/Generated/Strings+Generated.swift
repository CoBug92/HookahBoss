...
public enum L10n {
  ...
  public enum Articles {
    ...
    /// Continue reading
    public static let continueReading = L10n.tr("Localizable", "articles.continueReading", fallback: "Continue reading")
    /// %lld article
    public static func countLld(_ p1: Int) -> String {
      return L10n.tr("Localizable", "articles.count %lld", p1, fallback: "%lld article")
    }
    /// Editor's choice
    public static let editorChoice = L10n.tr("Localizable", "articles.editorChoice", fallback: "Editor's choice")
    ...
    public enum Cached {
      /// The latest update failed, so some information may be out of date.
      public static let message = L10n.tr("Localizable", "articles.cached.message", fallback: "The latest update failed, so some information may be out of date.")
      /// Showing saved articles
      public static let title = L10n.tr("Localizable", "articles.cached.title", fallback: "Showing saved articles")
    }
    ...
    public enum Empty {
      /// The editorial team is preparing fresh guides. Check back soon.
      public static let message = L10n.tr("Localizable", "articles.empty.message", fallback: "The editorial team is preparing fresh guides. Check back soon.")
      /// New stories are on the way
      public static let title = L10n.tr("Localizable", "articles.empty.title", fallback: "New stories are on the way")
    }
    public enum Error {
      /// Check your connection and try again.
      public static let message = L10n.tr("Localizable", "articles.error.message", fallback: "Check your connection and try again.")
      /// Couldn’t load articles
      public static let title = L10n.tr("Localizable", "articles.error.title", fallback: "Couldn’t load articles")
    }
  }
  public enum Auth {
    /// Continue with Apple
  ...
  public enum Collection {
    ...
    public enum Favorites {
      public enum Empty {
        /// Add a mix to favorites and it will appear here.
        public static let message = L10n.tr("Localizable", "collection.favorites.empty.message", fallback: "Add a mix to favorites and it will appear here.")
        /// No favorite mixes yet
        public static let title = L10n.tr("Localizable", "collection.favorites.empty.title", fallback: "No favorite mixes yet")
      }
    }
    public enum Personal {
      public enum Empty {
        /// Create your first mix to keep its composition close at hand.
        public static let message = L10n.tr("Localizable", "collection.personal.empty.message", fallback: "Create your first mix to keep its composition close at hand.")
        /// No personal mixes yet
        public static let title = L10n.tr("Localizable", "collection.personal.empty.title", fallback: "No personal mixes yet")
      }
    }
  }
  public enum Common {
    ...
    /// Refresh
    public static let refresh = L10n.tr("Localizable", "common.refresh", fallback: "Refresh")
    /// Retry
  ...
  public enum Home {
    ...
    /// Let’s mix
    public static let question = L10n.tr("Localizable", "home.question", fallback: "Let’s mix")
    /// Recommended today
    ...
    public enum Cached {
      /// Couldn’t refresh. This information may be outdated.
      public static let message = L10n.tr("Localizable", "home.cached.message", fallback: "Couldn’t refresh. This information may be outdated.")
      /// Showing saved mixes
      public static let title = L10n.tr("Localizable", "home.cached.title", fallback: "Showing saved mixes")
    }
    public enum Empty {
      /// We’re preparing new recommendations. Check back soon.
      public static let message = L10n.tr("Localizable", "home.empty.message", fallback: "We’re preparing new recommendations. Check back soon.")
      /// Fresh mixes are coming
      public static let title = L10n.tr("Localizable", "home.empty.title", fallback: "Fresh mixes are coming")
    }
    public enum Error {
      /// Check your connection and try again.
      public static let message = L10n.tr("Localizable", "home.error.message", fallback: "Check your connection and try again.")
      /// Couldn’t load mixes
      public static let title = L10n.tr("Localizable", "home.error.title", fallback: "Couldn’t load mixes")
    }
    public enum FindMix {
  ...
  public enum Mixes {
    public enum Cached {
      /// Couldn’t refresh the catalog. This information may be outdated.
      public static let message = L10n.tr("Localizable", "mixes.cached.message", fallback: "Couldn’t refresh the catalog. This information may be outdated.")
      /// Showing saved mixes
      public static let title = L10n.tr("Localizable", "mixes.cached.title", fallback: "Showing saved mixes")
    }
    public enum Empty {
      /// The catalog is being updated. Check back a little later.
      public static let message = L10n.tr("Localizable", "mixes.empty.message", fallback: "The catalog is being updated. Check back a little later.")
      /// No mixes yet
      public static let title = L10n.tr("Localizable", "mixes.empty.title", fallback: "No mixes yet")
    }
    public enum Error {
      /// Check your connection and try again.
      public static let message = L10n.tr("Localizable", "mixes.error.message", fallback: "Check your connection and try again.")
      /// Couldn’t load the catalog
      public static let title = L10n.tr("Localizable", "mixes.error.title", fallback: "Couldn’t load the catalog")
    }
    public enum Search {
      public enum Empty {
        /// Try another name or flavor.
        public static let message = L10n.tr("Localizable", "mixes.search.empty.message", fallback: "Try another name or flavor.")
        /// No matches
        public static let title = L10n.tr("Localizable", "mixes.search.empty.title", fallback: "No matches")
      }
    }
  }
